            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-3">
              ...
              <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50 p-3">
                ...
                <button
                  ...
                  className={[
                    "mt-3 flex w-full items-center justify-center gap-2 rounded-xl border px-3 py-2.5 text-xs font-semibold transition disabled:cursor-not-allowed disabled:opacity-50",
                    isStructureOpen
                ...
                {availabilityMessage ? (
                  ...
                  <p className="mt-2 text-center text-[9px] leading-4 text-slate-400">
                    La modifica viene salvata nel calendario della struttura.
                  </p>
                )}
              </div>
            </div>
...
function getCalendarDayPricing({
  date,
  priceOverrides,
  rangeStart,
  rangeEnd,
